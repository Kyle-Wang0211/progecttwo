...
ROOT_DIR="${ROOT_DIR:-/opt/object_fast_publish_v1}"
CONTROL_PLANE_DIR="${CONTROL_PLANE_DIR:-${ROOT_DIR}/control_plane}"
VENV_DIR="${VENV_DIR:-${ROOT_DIR}/venv}"
ENV_FILE="${ENV_FILE:-${ROOT_DIR}/worker_object_fast_publish_v1.env}"
...
exec "${VENV_DIR}/bin/python" -m worker_object_fast_publish_v1.main
