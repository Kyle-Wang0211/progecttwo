...
def main() -> None:
    ...
    print(
        f"[object_splatslam_v1] worker started worker_id={worker_id} base_url={config.control_plane_base_url}",
        flush=True,
    )
    ...
    while True:
        ...
        try:
            ...
            traceback.print_exc()
            print("[object_splatslam_v1] worker loop exception", flush=True)
            claimed = False
